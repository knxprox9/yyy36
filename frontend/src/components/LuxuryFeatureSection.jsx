    ...
    <div className="w-full" dir="rtl">
      ...
      <div className="relative">
        ...
        <div className="relative z-10">
          <div className="relative h-20 px-2 pt-[4px]">
            <div
            ...
            />
            <div className="absolute left-4 right-4 top-8 -translate-y-1/2 grid grid-cols-2 gap-[26px] justify-between pointer-events-none items-start">
              {/* Three nodes */}
